...
export function PublishSiteModal({ isOpen, onClose, project, onPublishSuccess }: PublishSiteModalProps) {
    ...
    return (
        <>
           ...
           <div data-tour="top-bar-publish-template-web" className="fixed left-1/2 top-1/2 z-50 grid w-full max-w-lg max-h-[90vh] -translate-x-1/2 -translate-y-1/2 gap-4 overflow-y-auto border bg-background p-6 shadow-lg duration-200 sm:rounded-lg">
                {/* Header */}
